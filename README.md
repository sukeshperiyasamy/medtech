...
- **`source/`** — other originals: `brand/` (logo and seal masters), `people/`, `centre/`, `achievements/` (the achievements deck), `backgrounds/` (hero background image masters, not currently used) and `icmi-2025-heic/` (HEIC masters, ignored by git for size).
