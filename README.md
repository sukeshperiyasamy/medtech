...
- **`source/`** — other originals: `brand/` (logo and seal masters), `people/`, `centre/`, `achievements/` (the achievements deck) and `icmi-2025-heic/` (HEIC masters, ignored by git for size).
