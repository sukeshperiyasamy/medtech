...
export const pathways: CollaborationPathway[] = [
  ...
  { id: "industry", audience: "Industry", title: "Technology development", description: "Sponsored research, co-development and access to interdisciplinary talent.", cta: { label: "Talk to the Center", url: mail("Industry partnership") } },
